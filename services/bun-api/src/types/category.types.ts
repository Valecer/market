...
export const CategoryReviewItemSchema = Type.Object({
  ...
  supplier_id: Type.Union([Type.Number(), Type.Null()], {
    description: 'Original supplier ID (for tracking)',
  }),
...
export const CategoryApprovalResponseSchema = Type.Object({
  ...
  category_id: Type.Number({
    description: 'Affected category ID',
  }),
  action: Type.Union([Type.Literal('approve'), Type.Literal('merge')], {
...
export const BulkCategoryApprovalRequestSchema = Type.Object({
  category_ids: Type.Array(Type.Number(), {
    minItems: 1,
    maxItems: 100,
    description: 'Array of category IDs to approve',
  }),
})
